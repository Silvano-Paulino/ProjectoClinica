  ...
  <div class="container">
    <div class="mod-form ">
      <form method="POST" action="../assets/php/logar.php">
        <div class="mb-3">
          <?php 
            if(!empty($_SESSION['logando'])) {
              
              $msg = $_SESSION['logando'];
          ?>
        ...
        <div class="mb-3">
          ...
          <div id="emailHelp" class="form-text" style="color: #fff;">Nós nunca vamos partilhar a sua senha com alguém.</div>
        </div>
        <div class="mb-3">
          <label for="exampleInputPassword1" class="form-label">Senha</label>
          <input type="password" class="form-control" name="senha" id="exampleInputPassword1">
        </div>
        <div class="mb-3 paraC form-check">
          <input type="checkbox" class="form-check-input" id="exampleCheck1">
          <label class="form-check-label" for="exampleCheck1">Check me out</label>
        </div>
        <button type="submit" name="logando" class="btn btn-primary mb-3">Iniciar sessão</button>
      </form>
    </div>
</div>
