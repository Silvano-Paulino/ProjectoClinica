    ...
    <main class="mt-5 pt-3">
      <div class="container-fluid">
        ...
        <!---------------------->
          ...
          <form class="row bg-light mt-5" action="http://localhost/clinicaaf/admin/php/imagem.php" method="post" enctype="multipart/form-data">
            <div class="col p-5">
              <div id="prever">
              ...
              <div style="padding: 1.2em 0 0 9px">
                ...
                <input type="hidden" name="id" value="<?php echo $_SESSION['idU'] ?>">   
              </div>
              <div class="modal-footer my-4">
                <button type="button" class="btn btn-secondary" onClick="window.location.href='cadastAdmin.php'">Cancelar</button>
