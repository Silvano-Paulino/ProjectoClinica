    ...
    <div class="mod-form">
      <form method="POST" action="../assets/php/logar.php">
        ...
        <div class="mb-3">
          ...
          <div id="emailHelp" class="form-text paraC">Nós nunca vamos partilhar a sua senha com alguém.</div>
        </div>
        <div class="mb-3">
        ...
        <button type="submit" name="logar" class="btn btn-primary">Iniciar sessão</button>
        <div class="my-3 paraC">
          <p>Não tens uma conta? <a href="cadastro.php">Registro</a></p>
        </div>
      </form>
    </div>
</div>
